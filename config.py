dataset = 'questions' # choice: ['Citeseer', 'squirrel', 'chameleon', "squirrel_filtered", "chameleon_filtered", "amazon_ratings", "minesweeper", "tolokers", "questions", "Cora", "DBLP", "CS", "Physics", "arxiv", "Flickr", "Reddit"]

optimization = 'am' # choice: ['gp' for gaussian process, 'am' for alternating minimization, 'normal' for Adam]

model = 'Morgan' # choice: ['SLOG_B', 'SLOG_N', 'Morgan']

assert model == 'Morgan' or optimization not in ['gp', 'am'], "SLOG_N is not currently supported with gp or am"
